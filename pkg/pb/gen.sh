...
ELASTICELL_PB_PATH="${GOPATH}/src/github.com/201341/elasticell/pkg/pb"


for dir in ${DIRS}; do
	pushd ${dir}
		protoc --gofast_out=plugins=grpc,import_prefix=github.com/201341/elasticell/pkg/pb/:. -I=.:"${GOGOPROTO_PATH}":"${ELASTICELL_PB_PATH}":"${GOPATH}/src" *.proto
